...
| [start.sh can't recover from bad Overmind state](start-sh-stale-overmind-socket.md) | infrastructure | high | resolved | 3 ⬆ (promotion-eligible) |
| [npx serves a stale cached upgrade tool](npx-cache-serves-stale-upgrade-tool.md) | tooling | medium | resolved | 1 |
