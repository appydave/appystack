...
export default function LandingPage() {
  return (
    <div className="min-h-screen">
      <header className="py-16 text-center bg-dark-bg">
        <pre className="inline-block text-left text-sm md:text-base leading-tight text-terminal-green font-mono">
          {ASCII_BANNER}
        </pre>
        <p className="mt-4 text-lg text-terminal-green-dim font-mono">
